...
urlpatterns = patterns('',
		...
		url(r'^category/(?P<category_name_url>[a-z A-Z _ 0-9]+)/add_page/$', views.add_page, name='add_page'), # for add_page again because the previous function was asinged two aguments so this was to all us to access the page withou adding arguments.
